...
function App() {
  ...
  return (
    <div>
      ...
      <Route
        path=''
        element={<HomePage loggedUser={loggedUser} startCity={startCity} destinationCity={destinationCity} setStartCity={setStartCity} setDestinationCity={setDestinationCity} />}
      />
        ...
        <Route path='/calender' element={<Calendar loggedUser={loggedUser} startCity={startCity} destinationCity={destinationCity} setStartCity={setStartCity} setDestinationCity={setDestinationCity}/>} />
